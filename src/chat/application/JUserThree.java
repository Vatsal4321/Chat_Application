...
public class JUserThree extends JFrame implements ActionListener, Runnable {
    ...
    JUserThree() {
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("chat/application/Icons/bill.png"));
        l3 = new JLabel(i7);
        ...
        l5 = new JLabel("Bill Gates");
        l5.setFont(new Font("SAN_SERIF", Font.PLAIN, 10));
        l5.setForeground(Color.WHITE);
        l5.setBounds(76, 32, 120, 10);
        add(l5);
        t = new Timer(1, new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (!typing) {
                    l5.setText("Bill Gates");
                }
            }
        });
    ...
    public static void main(String[] args) {
        JUserThree three = new JUserThree();
